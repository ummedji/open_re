...
<div class="control-group<?php echo form_error('email') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <input class="<?php echo $controlClass; ?> form-control input-medium " type="text" id="email" name="email" value="<?php echo set_value('email', isset($user) ? $user->email : ''); ?>" />
...
<div class="control-group<?php echo form_error('username') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <input class="<?php echo $controlClass; ?> form-control input-medium" type="text" id="username" name="username" value="<?php echo set_value('username', isset($user) ? $user->username : ''); ?>" />
