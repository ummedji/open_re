                        ...
                        <div class="default_box_white">
                            <div class="col-md-12 text-center tp_form inline-parent">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="planning_date" id="planning_date"  value="<?php echo $activity_planning['activity_planning_date'] ?>" placeholder="">
                                </div>
                                <?php
                                            ...
                                            <select class="selectpicker" id="activity_type_id" name="activity_type_id" data-live-search="true" disabled>
                                                ...
                                                if(isset($activity_type) && !empty($activity_type)) {
                                                    foreach ($activity_type as $key => $val) {
                                                        ?>
                                                        <option <?php if($val['activity_type_country_id'] == $activity_planning["activity_type_id"]){ echo "selected"; } ?> value="<?php echo $val['activity_type_country_id']; ?>" code="<?php echo $val['activity_type_code']; ?>"><?php echo $val['activity_type_country_name']; ?></option>
                                                        <?php
                                                    }
                                                }
                                                ?>
...
/*                                        }*/
                                       ...
                                       ?>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8">
                                                <textarea class="form-control" rows="4" name="activity_address" id="activity_address"><?php echo $activity_planning['location']?></textarea>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group frm_details text-center" style="margin-bottom: 0px;">
                                                    ...
                                                    <input type="text" class="form-control" name="size_of_plot" id="size_of_plot" value="<?php echo (!isset($activity_planning['size_of_plot']) ? $activity_planning['size_of_plot'] : 0 ) ?>" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-md-6 corp_text mrg_top_30">
                                                <div class="form-group frm_details text-center">
                                                    <label>Spray Volume</label>
                                                    <input type="text" class="form-control" name="spray_volume" id="spray_volume" value="<?php echo (!isset($activity_planning['spray_volume']) ? $activity_planning['spray_volume'] : 0 ) ?>" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group frm_details text-center" style="margin-bottom: 0px;">
                                                ...
                                                <select class="selectpicker" name="farmer_id" id="farmer_id" data-live-search="true">
                                                    ...
                                                    {
                                                        ?>
                                                        <option value="<?php echo $vkf['id']; ?>"  attr-name ="<?php echo $vkf['display_name']; ?>"><?php echo $vkf['display_name']; ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                            ...
                            <div class="default_box_grey">
                                <div class="col-md-10 col-md-offset-1 text-center tp_form inline-parent">
                                    <div class="form-group" style="margin-bottom: 0;">
                                        ...
                                        <input type="text" class="form-control" name="attandence_count" id ="attandence_count" value="<?php echo $activity_planning['proposed_attandence_count'] ?>" placeholder="" style="width: 80px;">
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group frm_details text-center" style="margin-bottom: 0px;">
                                            ...
                                            <input type="text" class="form-control" name="pod" value="<?php echo (isset($activity_planning['point_discussion']) ? $activity_planning['point_discussion'] : '');?>" id="pod" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-6 corp_text mrg_top_30">
                                        <div class="form-group frm_details text-center">
                                            <label>Set Alert </label>
                                            <textarea class="form-control" rows="3" name="set_alert"><?php echo (isset($activity_planning['alert']) ? $activity_planning['alert'] : '');?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <input class="activity_planning_id" type="hidden" name="inserted_activity_planning_id" id="activity_planning_id" value="<?php echo $activity_planning['activity_planning_id'];?>" />
            ...
            <div class="col-md-12 table_bottom pln_table_bottom">
                <div class="row">
                    <div class="save_btn">
                        <button type="button" class="btn btn-primary" name = 'update_planning' id="check_update">Update</button>
