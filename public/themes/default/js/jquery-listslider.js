        ...
        function initListsliderFor(element) {
            try {
                ...
                self.setupParentDiv = function () {
                    ...
                    if (ie_ver != false) {
                        self.ul.parents('div.nav-parent-div').css('position', 'relative');
                    } else {
                ...
                self.showPaginationIfWrapperIsHidden = function () {
                    ...
                    if (ie_ver != false) {
                        if ($(self.ul.parents('div.nav-parent-div')).width() < wrapper_width) {
                            $(self.ul.parents('div.nav-parent-div')).find('.listslider-arrow').addClass('active');
                        } else {
                            $(self.ul.parents('div.nav-parent-div')).find('.listslider-arrow').removeClass('active');
                        }
                    } else {
                ...
                self.addArrows = function () {
                    if (ie_ver != false) {
                        self.ul.parents('div.nav-parent-div').append('<div class="listslider-left listslider-arrow">' + config.left_label + '</div>');
                        self.ul.parents('div.nav-parent-div').append('<div class="listslider-right listslider-arrow">' + config.right_label + '</div>');
                    } else {
                ...
                self.attachEventsToElements = function () {
                    ...
                    if(ie_ver != false){
                        $(self.ul.parents('div.nav-parent-div')).on('click', '.listslider-arrow', function(){
