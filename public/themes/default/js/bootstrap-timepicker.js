  ...
  Timepicker.prototype = {
    ...
    _init: function() {
      ...
      if (this.$element.parent().hasClass('input-group')) {
        if (this.$element.parent('.input-group').find('.input-group-time').length) {
          this.$element.parent('.input-group').find('.input-group-time').on({
            'click.timepicker': $.proxy(this.showWidget, this)
          });
        } else {
          this.$element.closest(this.containerClass).find('.input-group-time').on({
            'click.timepicker': $.proxy(this.showWidget, this)
          });
        }
