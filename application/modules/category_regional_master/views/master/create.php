...
<div class='admin-box portlet box green'>
 <div class='portlet-title'>
        <div class='caption'>
            <i class='fa fa-pencil'></i> Create Category Regional Master
        </div>
    </div>
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		...
		<fieldset class='form-actions'>
			<input type='submit' name='save' class='btn green' value="<?php echo lang('category_regional_master_action_create'); ?>" />
			<?php echo lang('bf_or'); ?>
