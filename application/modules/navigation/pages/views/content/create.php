...
<div class="admin-box  portlet box green">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-pencil"></i> Create Pages
        </div>
    </div>
    ...
    <fieldset>
        <div class="control-group  <?php echo form_error('page_title') ? 'has-error' : ''; ?>">
            <?php echo form_label('Page Title' . lang('bf_form_label_required'), 'page_title', array('class' => "col-md-3 control-label ")); ?>
            <div class='controls'>
                <input id="page_title" type="text" name="page_title" maxlength="100" class="form-control input-medium"
        ...
        <div class="control-group <?php echo form_error('page_slug') ? 'has-error' : ''; ?>">
            <?php echo form_label('Page Slug' . lang('bf_form_label_required'), 'page_slug', array('class' => "control-label col-md-3")); ?>
            <div class='controls'>
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn green" value="Create Pages"/>
