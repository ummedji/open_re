...
class Migration_Install_esp_permissions extends Migration
{
	/**
	...
	private $permissionValues = array(
		array(
			'name' => 'Esp.Content.View',
			'description' => 'View Esp Content',
			'status' => 'active',
		),
		array(
			'name' => 'Esp.Content.Create',
			'description' => 'Create Esp Content',
			'status' => 'active',
		),
		array(
			'name' => 'Esp.Content.Edit',
			'description' => 'Edit Esp Content',
			'status' => 'active',
		),
		array(
			'name' => 'Esp.Content.Delete',
			'description' => 'Delete Esp Content',
			'status' => 'active',
		),
    );
