...
<div class='admin-box portlet box green'>
 <div class='portlet-title'>
        <div class='caption'>
            <i class='fa fa-pencil'></i> Edit Category Applicable Master
        </div>
    </div>
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		...
		<fieldset class='form-actions'>
			<input type='submit' name='save' class='btn green' value="<?php echo lang('category_applicable_master_action_edit'); ?>" />
			<?php echo lang('bf_or'); ?>
			<?php echo anchor(SITE_AREA . '/master/category_applicable_master', lang('category_applicable_master_cancel'), 'class="btn default"'); ?>
			
			<?php if ($this->auth->has_permission('Category_Applicable_Master.Master.Delete')) : ?>
				<?php echo lang('bf_or'); ?>
				<button type='submit' name='delete' formnovalidate class='btn btn-danger' id='delete-me' onclick="return confirm('<?php e(js_escape(lang('category_applicable_master_delete_confirm'))); ?>');">
					<span class='icon-trash icon-white'></span>&nbsp;<?php echo lang('category_applicable_master_delete_record'); ?>
				</button>
			<?php endif; ?>
		</fieldset>
    <?php echo form_close(); ?>
