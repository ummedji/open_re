$(document).ready(function() {
    ...
    var retailer_compititor_view_validators = $("#retailer_compititor_view").validate({
        rules: {
            from_month:{
                required: true
            },
    ...
    $("#retailer_compititor_view").on("submit",function(e){
        e.preventDefault();
        var param = $("#retailer_compititor_view").serializeArray();

        var $valid = $("#retailer_compititor_view").valid();
        if(!$valid) {
            retailer_compititor_view_validators.focusInvalid();
            return false;
        }
        else
        {
            $.ajax({
                type: 'POST',
                url: site_url+'ecp/retailer_compititor_details_view',
                data: param,
...
$(document).on('click', 'div.retailer_view_cont .delete_i', function () {
