            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center tp_form">
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <input type="hidden" name="planning_id" value="" id="planning_id"
                               class="form-control planning_id"/>
                        <textarea name="cancle_reson" id="cancle_reson" cols="25" rows="5"></textarea>
                    </div>
                </div>
                <div class="modal-footer text-center save_btn">
                    <button id="save_cancle_reson" type="button" class="btn btn-primary gren_btn" title="Save Change">
                        Save
                    </button>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center tp_form">
                    <div class="form-group">
                        ...
                        <input type="text" name="planning_date" value="" id="planning_date"
                               class="form-control planning_id"/>
                    </div>
                    <div class="form-group">
                    ...
                    <input type="hidden" name="planning_id" value="" id="plannings_id"
                           class="form-control planning_id"/>
                    <!--  <div class="form-group" style="margin-bottom: 0;">
                ...
                <div class="modal-footer text-center save_btn">
                    <button id="save_re_data" type="button" class="btn btn-primary gren_btn" title="Save Change">Save
                    </button>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 tp_form inline-parent corp_text corp_text_align">
                                            <div class="form-group" style="margin-bottom: 0px;">
                                                ...
                                                <select class="selectpicker" name="crop[]" id="crop"
                                                        data-live-search="true"
                                                        multiple title="Select Crop">
                                                    <option value=""></option>
                                                    <?php
                                                    if (isset($crop_details) && !empty($crop_details)) {
                                                        foreach ($crop_details as $key => $val) {
                                                            ?>
                                                            <option
                                                                value="<?php echo $val['crop_country_id']; ?>"><?php echo $val['crop_name']; ?></option>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 tp_form inline-parent corp_text corp_text_align">
                                            <div class="form-group" style="margin-bottom: 0px;">
                                                ...
                                                <select class="selectpicker" name="product_sku[]" id="product_sku"
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 tp_form inline-parent corp_text corp_text_align">
                                            <div class="form-group" style="margin-bottom: 0px;">
                                                ...
                                                <select class="selectpicker" name="diseases[]" id="diseases"
                                                        data-live-search="true" multiple>
