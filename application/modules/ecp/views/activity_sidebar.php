<div class="top_form planning_parent" style="padding: 10px 5px 10px 5px;">
    <div class="panel act_panel with-nav-tabs panel-default">
                                ...
                                <?php if ($key == 0) { ?>
                                    <div class="panel-heading" role="tab">
                                        <ul class="acc_list">
                                            ...
                                            <li><a href="javascript: void(0);"
                                                   onclick="getActivityById(<?php echo $val['activity_planning_id']; ?>);">Execute
                                            </li>
                                            <li><a href="#" id="activity_cancel" data-toggle="modal"
                                                   data-target="#ActivityCancelModal"
                                                   onclick="getActivityPlanningId(<?php echo $val['activity_planning_id']; ?>);">Cancel</a>
                                            </li>
                                            <li><a href="#" id="activity_re" data-toggle="modal"
                                                   data-target="#ActivityReModal"
                                                   onclick="getActivityPlanningsId(<?php echo $val['activity_planning_id']; ?>);">Rescheduling</a>
                                            </li>
                                        </ul>
                                    </div>
                                <?php } else { ?>
                                    ...
                                    <ul class="acc_list">
                                        ...
                                        <li><a href="javascript: void(0);"
                                               onclick="getActivityCancelById(<?php echo $val['activity_planning_id']; ?>);">Cancel
                                        </li>
        ...
        } elseif ($action == 'activity_planning') { ?>
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="tab1default">
                    ...
                    if ($action == 'activity_view') { ?>
                        ...
                        <div class="clearfix"></div>
                    <?php } elseif ($action == 'activity_execution') { ?>
                        <div id="accordion" class="as_accordion" role="tablist" aria-multiselectable="true">
                            <?php
                            if (is_array($activity_data) && count($activity_data) > 0) {
                                $j = 0;
