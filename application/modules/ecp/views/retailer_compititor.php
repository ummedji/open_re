...
<?php
$attributes = array('class' => '', 'id' => 'retailer_compititor','name'=>'retailer_compititor');
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 tp_form">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="month_da" id="month_da" placeholder=""/>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6 tp_form">
                                <div class="form-group">
