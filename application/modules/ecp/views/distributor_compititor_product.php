...
<?php
$attributes = array('class' => '', 'id' => 'distributor_compititor_product','name'=>'distributor_compititor_product');
    ...
    <div class="row">
        <div class="middle_form">
            <div class="row">
                ...
                <div class="col-md-2_ tp_form">
                    <div class="form-group">
                        <label for="invoice_date">Qty.</label>
