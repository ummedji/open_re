            ...
            <div class="row">
                <div class="col-md-12 text-center sub_nave">
                    <div class="inn_sub_nave">
                        <ul>
                            <li class="<?php echo ($this->uri->segment(1) == 'ishop' && $this->uri->segment(2) == 'order_approval' && $this->uri->segment(3) == 'dispatched') ? 'active' : ''; ?>">
                                <a href="<?php echo base_url('/ishop/order_approval/dispatched') ?>">Dispatched</a></li>
                            <li class="<?php echo ($this->uri->segment(1) == 'ishop' && $this->uri->segment(2) == 'order_approval' && $this->uri->segment(3) == 'pending') ? 'active' : ''; ?>">
                                <a href="<?php echo base_url('/ishop/order_approval/pending') ?>">Pending
                                    <div class="pending_counts"><?php echo $pending_count ?></div>
                                </a></li>
                            <li class="<?php echo ($this->uri->segment(1) == 'ishop' && $this->uri->segment(2) == 'order_approval' && $this->uri->segment(3) == 'reject') ? 'active' : ''; ?>">
                                <a href="<?php echo base_url('/ishop/order_approval/reject') ?>">Reject</a></li>
                            <li class="<?php echo ($this->uri->segment(1) == 'ishop' && $this->uri->segment(2) == 'order_approval' && $this->uri->segment(3) == 'all') ? 'active' : ''; ?>">
                                <a href="<?php echo base_url('/ishop/order_approval/all') ?>">All</a></li>
                        </ul>
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="row">
                        ...
                        <input class="login_customer_type" type="hidden" name="login_customer_type"
                               id="login_customer_type" value="<?php echo $login_customer_type; ?>"/>
                        ...
                        <input class="renderdata" type="hidden" name="renderdata" id=""
