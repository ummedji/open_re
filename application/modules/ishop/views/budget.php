        ...
        <div class="col-md-9">
            <div class="row">
                ...
                <div class="col-md-8 chech_data"><button type="submit" class="btn btn-default">Check Data</button>
                    <a id="distributor_xl" href="javascript:void(0);" onclick='window.open("<?php echo base_url('assets/uploads/Uploads/budget/budget_distributor.xlsx'); ?>","_blank" );' class="btn btn-default">Download Templates</a>
                    <a style="display:none;" id="retailer_xl" href="javascript:void(0);" onclick='window.open("<?php echo base_url('assets/uploads/Uploads/budget/budget_retailer.xlsx'); ?>","_blank" );' class="btn btn-default">Download Templates</a></div>
                <?php echo form_close(); ?>
