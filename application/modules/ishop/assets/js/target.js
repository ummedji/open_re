...
$(document).on('click', 'div.target_container .edit_i', function () {
...
$(document).on('click', 'div.target_container .delete_i', function () {
    var id = $(this).attr('prdid');
    $('<div></div>').appendTo('body')
        ...
        .dialog({
            ...
            buttons: {
                OK: function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: site_url+'ishop/delete_target_details',
                        data: {target_id:id},
                        success: function(resp){
                            location.reload();
                        }
...
$(document).on("submit","#copy_popup",function() {
    ...
    if (!$valid) {
        ...
        target_pop_up_validators.focusInvalid();
        return false;
    }
    else {
