...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        <div class="control-group <?php echo form_error('role_id') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="role_id" type="text" name="role_id" maxlength="255" value="<?php echo set_value('role_id', isset($user_management['role_id']) ? $user_management['role_id'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('email') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="email" type="text" name="email" maxlength="120" value="<?php echo set_value('email', isset($user_management['email']) ? $user_management['email'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('username') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="username" type="text" name="username" maxlength="30" value="<?php echo set_value('username', isset($user_management['username']) ? $user_management['username'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('password_hash') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="password_hash" type="text" name="password_hash" maxlength="40" value="<?php echo set_value('password_hash', isset($user_management['password_hash']) ? $user_management['password_hash'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('reset_hash') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="reset_hash" type="text" name="reset_hash" maxlength="40" value="<?php echo set_value('reset_hash', isset($user_management['reset_hash']) ? $user_management['reset_hash'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('salt') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="salt" type="text" name="salt" maxlength="7" value="<?php echo set_value('salt', isset($user_management['salt']) ? $user_management['salt'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('last_login') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="last_login" type="text" name="last_login"  value="<?php echo set_value('last_login', isset($user_management['last_login']) ? $user_management['last_login'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('last_ip') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="last_ip" type="text" name="last_ip" maxlength="40" value="<?php echo set_value('last_ip', isset($user_management['last_ip']) ? $user_management['last_ip'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('deleted') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="deleted" type="text" name="deleted" maxlength="1" value="<?php echo set_value('deleted', isset($user_management['deleted']) ? $user_management['deleted'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('banned') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="banned" type="text" name="banned" maxlength="1" value="<?php echo set_value('banned', isset($user_management['banned']) ? $user_management['banned'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('ban_message') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="ban_message" type="text" name="ban_message" maxlength="255" value="<?php echo set_value('ban_message', isset($user_management['ban_message']) ? $user_management['ban_message'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('reset_by') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="reset_by" type="text" name="reset_by" maxlength="10" value="<?php echo set_value('reset_by', isset($user_management['reset_by']) ? $user_management['reset_by'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('display_name') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="display_name" type="text" name="display_name" maxlength="255" value="<?php echo set_value('display_name', isset($user_management['display_name']) ? $user_management['display_name'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('display_name_changed') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="display_name_changed" type="text" name="display_name_changed"  value="<?php echo set_value('display_name_changed', isset($user_management['display_name_changed']) ? $user_management['display_name_changed'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('timezone') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="timezone" type="text" name="timezone" maxlength="4" value="<?php echo set_value('timezone', isset($user_management['timezone']) ? $user_management['timezone'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('language') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="language" type="text" name="language" maxlength="20" value="<?php echo set_value('language', isset($user_management['language']) ? $user_management['language'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('activate_hash') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="activate_hash" type="text" name="activate_hash" maxlength="40" value="<?php echo set_value('activate_hash', isset($user_management['activate_hash']) ? $user_management['activate_hash'] : ''); ?>"  />
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Create User Management" />
            or <?php echo anchor(SITE_AREA .'/settings/user_management', lang('user_management_cancel'), 'class="btn btn-warning"'); ?>
