...
class Migration_Install_user_management_permissions extends Migration {
    ...
    public function __construct() {
        ...
        $permissions = array(
            array('name' => "{$this->module_config['module_permission_name']}.Settings.View", 'description' => '', 'status' => 'active',),
            array('name' => "{$this->module_config['module_permission_name']}.Settings.Create", 'description' => '', 'status' => 'active',),
            array('name' => "{$this->module_config['module_permission_name']}.Settings.Edit", 'description' => '', 'status' => 'active',),
            array('name' => "{$this->module_config['module_permission_name']}.Settings.Delete", 'description' => '', 'status' => 'active',),
        );
