...
{
    protected $permissionCreate = 'Country_master.Master.Create';
    protected $permissionDelete = 'Country_master.Master.Delete';
    protected $permissionEdit   = 'Country_master.Master.Edit';
    protected $permissionView   = 'Country_master.Master.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_country_master()) {
				...
				redirect(SITE_AREA . '/master/country_master');
			}
