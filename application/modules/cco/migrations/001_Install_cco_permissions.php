...
class Migration_Install_cco_permissions extends Migration
{
	/**
	...
	private $permissionValues = array(
		array(
			'name' => 'Cco.Content.View',
			'description' => 'View Cco Content',
			'status' => 'active',
		),
		array(
			'name' => 'Cco.Content.Create',
			'description' => 'Create Cco Content',
			'status' => 'active',
		),
		array(
			'name' => 'Cco.Content.Edit',
			'description' => 'Edit Cco Content',
			'status' => 'active',
		),
		array(
			'name' => 'Cco.Content.Delete',
			'description' => 'Delete Cco Content',
			'status' => 'active',
		),
    );
