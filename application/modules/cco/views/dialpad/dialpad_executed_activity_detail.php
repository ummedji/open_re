...
<?php if((isset($activity_details['execution_date']) && !empty($activity_details['execution_date'])) && (isset($activity_details['execution_time']) && !empty($activity_details['execution_time']))){ ?>
    <div class="default_box_white">
        <div class="col-md-12 text-center tp_form inline-parent">
            <div class="form-group">
                ...
                {
                    $p_date = strtotime($activity_details['execution_date']);
                    $execution_date = date($current_user->local_date,$p_date);
                }
                else{
                    $execution_date = $activity_details['execution_date'];
                }
                ?>
            ...
            <?php
            if(isset($activity_details['execution_time']) && !empty($activity_details['execution_time'])){
                $time = explode(' ', $activity_details['execution_time']);
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="meeting_duration"  value="<?php echo (!empty($activity_details['meeting_duration']) ? $activity_details['meeting_duration'] : '');?>" id="meeting_duration" placeholder="" readonly />
            </div>
        </div>
    ...
    <div class="col-md-8 col-md-offset-2">
        <div id="no-more-tables">
            <table class="col-md-12 table-bordered table-striped table-condensed cf">
                ...
                <?php if (isset($activity_details['customer']) && !empty($activity_details['customer'])) {
                    foreach ($activity_details['customer'] as $k => $vmr) {
                        ?>
                        <tr>
...
<?php /*if((isset($activity_details['amount']) && !empty($activity_details['amount'])) || (isset($activity_details['rating']) && !empty($activity_details['rating']))) { */?><!--
        ...
        <div class="col-md-10 col-md-offset-1 text-center tp_form inline-parent">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group frm_details text-center" style="margin-bottom: 0px;">
                        <label>Amount</label>
                        <input type="text" class="form-control" name="amount" id="amount" value="<?php /*echo (!empty($activity_details['amount']) ? $activity_details['amount'] : '0')*/?>" placeholder="" readonly />
                    </div>
                </div>
                <div class="col-md-6 corp_text mrg_top_30">
                    <div class="form-group frm_details text-center">
                        ...
                        <input type="hidden" id="act_rat" class="form-control" name="rating" id="rating" value="<?php /*echo (!empty($activity_details['rating']) ? $activity_details['rating'] : '0')*/?>" placeholder="" />
                    </div>
                </div>
            </div>
        </div>
...
<?php /*if((isset($activity_details['activity_note']) && !empty($activity_details['activity_note']))) { */?>
    <div class="default_box_white">
        <div class="col-md-10 col-md-offset-1 text-center tp_form inline-parent">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group frm_details text-center" style="margin-bottom: 0px;">
                        ...
                        <textarea class="form-control" rows="3" cols="80" name="activity_note"><?php /*echo $activity_details['amount'];*/?></textarea>
                    </div>
                </div>
            </div>
        </div>
